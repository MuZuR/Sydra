...
exports.run = (client, message, args) => {
 if(!message.member.hasPermission("MANAGE_ROLES")) return message.channel.send(":no_entry: **rol-ver** komutunu kullanmak için **__Rolleri Yönet__** Yetkisine sahip olman gerkeli")
    if (!message.guild) {
