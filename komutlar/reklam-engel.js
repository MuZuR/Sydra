...
exports.run = async(client, message, args) => {
  ...
  if (!args[0]) return message.channel.send(`**Reklam Engel Sistemi Açmak İçin -reklam-engel #kanal veya -reklam-engel aç Yazmalsın**`)
  if (args[0] !== 'aç' && args[0] !== 'kapat') return message.channel.send(`**Reklam Engel Sistemi Açmak İçin -reklam-engel #kanal veya -reklam-engel aç Yazmalsın**`)
